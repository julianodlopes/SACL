...
/**
 * @author Gustavo, Ítalo, Juliano e Silas. Descrição: Classe que executa a
 * busca automática do CEP. Data de criação: 05/09/2015.
 *
 * Ferramenta de busca de CEP. {@link WebServiceCep#searchCep(String)} para
 * maiores informações.
 * <BR>
 * <BR>Constroi um objeto {@link WebServiceCep} com os dados XML encapsulados, a
 * partir da chamada do método estético {@link WebServiceCep#searchCep(String)}.
 * <BR>
...
public final class WebServiceCep {
    ...
    private enum Xml {
        ...
        /**
         * Seta o texto enviado no parâmetro <tt>text</tt> no objeto
         * {@link WebServiceCep} no seu parâmetro correspondente. Cada constante
         * do enum conhece o seu parâmetro a passar.
         *
         * @param text {@link String} contendo o texto a ser inserido.
         * @param webServiceCep {@link WebServiceCep} referência do objeto para
    ...
    /* Métodos e variáveis estáticas, responsáveis pela busca do CEP */
    /**
     * Máscara para a string url de conexão, onde <tt>"%s"</tt> é substituido
     * pelo valor do cep.
     */
     ...
     * @throws DocumentException Quando há problema na formatação do documento
     * XML.
     ...
     * qualquer formataçãoo, pois só serão consideradas os primeiros 8 numeros
     * da string.
     * <BR>Por Exemplo:
     ...
     * <BR><tt>-16</tt> : Erro na formatação da url
