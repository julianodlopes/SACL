 ...
 * propósito mostrar uma janela para pesquisa de substâncias no freezer. Funções
 * presente: ViewPesquisarFreezer(); itemSelecionado(); main(); Data de criação:
 * 05/09/2015.
 */
public class ViewPesquisarFreezer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelEquip.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabelEquip.setText("Nome:");
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        dispose();
        ViewEditarFreezer view = new ViewEditarFreezer(itemSelecionado());
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        ResultSet rs = query.mostrarFreezer(jTextFieldNome.getText());

        try {
            while (rs.next()) {
                model.addRow(new Object[]{
                    rs.getString("id_freezer"),
                    rs.getString("nome_fz"),
                    rs.getString("validade_fz")});
            }

            query.fecharConexao();

            //verificarSubstanciasVencidas();
            /*if (jTableNome.set) {
             jTableNome.setSelectionBackground(Color.black);
             }*/
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        int i = JOptionPane.showOptionDialog(null,
                "Você realmente deseja excluir o item selecionado?", "Confirmação",
    ...
    private void jTableNomeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableNomeMouseClicked
        ...
        jMenuItemAlterar.addActionListener(
                new java.awt.event.ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        ViewEditarFreezer vf = new ViewEditarFreezer(itemSelecionado());
                        vf.setVisible(true);
        ...
        if (evt.getButton() == MouseEvent.BUTTON1 && evt.getClickCount() == 2) {
            ViewInformacoesFreezer view = new ViewInformacoesFreezer(itemSelecionado());
            view.setVisible(true);
        }
    }//GEN-LAST:event_jTableNomeMouseClicked

    //Retorna o índice da substância do freezer.
    ...
    public void verificarSubstanciasVencidas() {
        QueryFreezer query = new QueryFreezer();
        array = new ArrayList();

        ResultSet rs = query.substanciasVencidas();

        try {
            while (rs.next()) {
                array.add(rs.getString("id_freezer"));
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPesquisarFreezer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPesquisarFreezer().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelEquip;
