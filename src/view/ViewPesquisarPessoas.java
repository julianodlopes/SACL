 ...
 * propósito mostrar uma janela para pesquisa de pessoas. Funções presente:
 * ViewPesquisarPessoas(); itemSelecionado(); main(); Data de criação:
 * 05/09/2015.
 */
public class ViewPesquisarPessoas extends javax.swing.JFrame {

    Object[] options = {"Sim", "Não"};  //Opções a serem mostradas no JOptionPane.

    /**
     * Creates new form ViewSubstancia
     */
    public ViewPesquisarPessoas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelPesquisarPessoas = new javax.swing.JLabel();
        ...
        jLabelPesquisarPessoas.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabelPesquisarPessoas.setText("Pesquisar pessoas");
                    ...
                    .addGroup(jPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanelLayout.createSequentialGroup()
                                ...
                                .addGap(55, 55, 55)
                                .addComponent(jLabelPesquisarPessoas)
                                .addGap(141, 141, 141))))
                    .addGroup(jPanelLayout.createSequentialGroup()
                        .addGap(46, 46, 46)
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        dispose();  //Fecha a janela atual.
        ViewEditarPessoa view = new ViewEditarPessoa(itemSelecionado());
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        ResultSet rs = query.mostrarPessoas(jTextFieldNome.getText());

        try {
            while (rs.next()) {
                model.addRow(new Object[]{
                    rs.getString("id_nome"),
                    rs.getString("nome_ps"),
                    rs.getString("email_ps")});
            }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        int i = JOptionPane.showOptionDialog(null,
                "Você realmente deseja excluir a pessoa selecionada?", "Confirmação",
    ...
    private void jTableNomeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableNomeMouseClicked
        ...
        jMenuItemAlterar.addActionListener(
                new java.awt.event.ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        ViewEditarPessoa vp = new ViewEditarPessoa(itemSelecionado());
                        vp.setVisible(true);
        ...
        if (evt.getButton() == MouseEvent.BUTTON1 && evt.getClickCount() == 2) {
            ViewInformacoesPessoa view = new ViewInformacoesPessoa(itemSelecionado());
            view.setVisible(true);
        }

    }//GEN-LAST:event_jTableNomeMouseClicked

    //Retorna o índice da pessoa.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPesquisarPessoas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPesquisarPessoas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelPesquisarPessoas;
