 ...
 * propósito mostrar uma janela para pesquisa de equipamentos. Funções presente:
 * ViewPesquisarEquipamentos(); itemSelecionado(); main(); Data de criação:
 * 05/09/2015.
 */
public class ViewPesquisarEquipamentos extends javax.swing.JFrame {
     ...
     */
    public ViewPesquisarEquipamentos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelPesquisarEquip = new javax.swing.JLabel();
        ...
        jLabelPesquisarEquip.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabelPesquisarEquip.setText("Pesquisar equipamentos");
                        ...
                        .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanelLayout.createSequentialGroup()
                                    ...
                                    .addGap(55, 55, 55)
                                    .addComponent(jLabelPesquisarEquip))
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        dispose();
        ViewEditarEquipamento view = new ViewEditarEquipamento(itemSelecionado());
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        ResultSet rs = query.mostrarEquipamentos(jTextFieldNome.getText());

        try {
            while (rs.next()) {
                model.addRow(new Object[]{
                    rs.getString("id_equip"),
                    rs.getString("nome_eq"),
                    rs.getString("modelo_eq")});
            }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        int i = JOptionPane.showOptionDialog(null,
                "Você realmente deseja excluir o equipamento selecionado?", "Confirmação",
        ...
        if (i == JOptionPane.YES_OPTION) {
            ...
            query.removerEquipamento(index);
    ...
    private void jTableNomeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableNomeMouseClicked
        ...
        jMenuItemAlterar.addActionListener(
                new java.awt.event.ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        ViewEditarEquipamento ve = new ViewEditarEquipamento(itemSelecionado());
                        ve.setVisible(true);
        ...
        if (evt.getButton() == MouseEvent.BUTTON1 && evt.getClickCount() == 2) {
            ViewInformacoesEquipamento view = new ViewInformacoesEquipamento(itemSelecionado());
            view.setVisible(true);
        }
    }//GEN-LAST:event_jTableNomeMouseClicked

    //Retorna o índice do equipamento.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPesquisarEquipamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPesquisarEquipamentos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelPesquisarEquip;
